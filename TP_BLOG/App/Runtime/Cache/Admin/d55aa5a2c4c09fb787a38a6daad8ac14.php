...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/TP_BLOG/index.php/Admin/Admin/sort" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/TP_BLOG/index.php/Admin/Admin/add"><i class="icon-font"></i>新增管理员</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ve): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($ve["username"]); ?>"><?php echo ($ve["username"]); ?></td>

                            <td>
                                <a class="link-update" href="/TP_BLOG/index.php/Admin/Admin/edit/id/<?php echo ($ve["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确认删除 ?');" href="/TP_BLOG/index.php/Admin/Admin/del/id/<?php echo ($ve["id"]); ?>">删除</a>
                            </td>
