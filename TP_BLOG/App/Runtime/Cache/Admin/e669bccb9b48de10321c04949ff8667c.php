...
<head>
    ...
    <script type="text/javascript" src="http://localhost/TP_BLOG/App/Admin/Public/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" src="http://localhost/TP_BLOG/App/Admin/Public/ueditor/ueditor.all.min.js"></script>
</head>
<body>
...
<div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/TP_BLOG/index.php/Admin/Cate/lst">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/TP_BLOG/index.php/Admin/Link/lst">文章管理</a><span class="crumb-step">&gt;</span><span>新增文章</span></div>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="cateid">
                                        ...
                                        <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ve): $mod = ($i % 2 );++$i;?><option value="<?php echo ($ve["id"]); ?>"><?php echo ($ve["catename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </td>
                            </tr>
                            <tr>
