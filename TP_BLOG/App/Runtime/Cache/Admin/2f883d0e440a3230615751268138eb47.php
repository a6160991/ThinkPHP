...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/TP_BLOG/index.php/Admin/Cate/sort" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/TP_BLOG/index.php/Admin/Cate/add"><i class="icon-font"></i>新增栏目</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ve): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><input name="id[]" value="59" type="checkbox"></td>
                            <td>
                                <input class="common-input sort-input" name="<?php echo ($ve["id"]); ?>" value="<?php echo ($ve["sort"]); ?>" type="text">
                            </td>
                            <td><?php echo ($ve["id"]); ?></td>
                            <td title="<?php echo ($ve["catename"]); ?>"><a target="_blank" href="#" title="内容"><?php echo ($ve["catename"]); ?></a>    
                            </td>

                            <td>
                                <a class="link-update" href="/TP_BLOG/index.php/Admin/Cate/edit/id/<?php echo ($ve["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确认删除 ?');" href="/TP_BLOG/index.php/Admin/Cate/del/id/<?php echo ($ve["id"]); ?>">删除</a>
                            </td>
