...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="http://localhost/TP_BLOG/Admin/Index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">文章管理</span></div>
        </div>
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/TP_BLOG/index.php/Admin/Article/sort" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/TP_BLOG/index.php/Admin/Article/add"><i class="icon-font"></i>新增文章</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ve): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><?php echo ($ve["id"]); ?></td>
                            <td title="<?php echo ($ve["title"]); ?>"><a target="_blank" href="#" title="<?php echo ($ve["title"]); ?>"><?php echo ($ve["title"]); ?></a>    
                            </td>
                            <td>
                                <?php if($ve['pic'] != '' ): ?><img src="/TP_BLOG<?php echo ($ve["pic"]); ?>" height="50">
                                    <?php else: ?>
                                    无缩略图<?php endif; ?>
                            </td>
                            <td><?php echo ($ve["catename"]); ?></a>    
                            <td>
                                <a class="link-update" href="/TP_BLOG/index.php/Admin/Article/edit/id/<?php echo ($ve["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确认删除 ?');" href="/TP_BLOG/index.php/Admin/Article/del/id/<?php echo ($ve["id"]); ?>">删除</a>
                            </td>
