    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
                <li><a class="on" href="http://localhost/TP_BLOG/App/Admin/Index">首页</a></li>
...
<div class="sidebar-wrap">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.html">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/jscss/admin/design/">管理员管理</a><span class="crumb-step">&gt;</span><span>新增管理员</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" type="password" id="password" name="password" size="50" value="" type="text"> 
                                    (空白为不修改)
                                </td>
                            </tr>
                                <th></th>
